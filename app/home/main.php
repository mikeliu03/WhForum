...
class main extends AWS_CONTROLLER
{
	...
	public function index_action()
	{
        ...
        if (is_mobile())
        {
            HTTP::redirect('/m/home/');
        }
		// 边栏可能感兴趣的人或话题
		if (TPL::is_output('block/sidebar_recommend_users_topics'.TPL::$template_ext, 'home/index'))
		{
		...
		// 边栏热门用户
		if (TPL::is_output('block/sidebar_hot_users'.TPL::$template_ext, 'home/index'))
		{
