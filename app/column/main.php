...
class main extends AWS_CONTROLLER
{
	...
	public function index_action()
	{
		...
		$recommend_info = $this->model('column')->fetch_column_list($this->user_id, 1 , 5 , 'sum' ,false);
	...
	public function details_action()
	{
        if(is_mobile())
        {
            HTTP::redirect('/m/column/details/'.$_GET['id']);
        }
