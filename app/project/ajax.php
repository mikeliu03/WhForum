...
class ajax extends AWS_CONTROLLER
{
	...
	public function publish_project_action()
	{
		...
		if (!is_digits(strtotime($_POST['start_time'])) OR !is_digits(strtotime($_POST['end_time'])))
		{
		...
		$project_id = $this->model('project')->publish_project($this->user_id, $_POST['project_type'], $_POST['category_id'], $_POST['title'], $_POST['country'], $_POST['province'], $_POST['city'], $_POST['summary'], $_POST['description'], $_POST['amount'], strtotime($_POST['start_time']), strtotime($_POST['end_time']), $_POST['contact'], $_POST['topics'], $_POST['video_link']);
	...
	public function update_project_action()
	{
		...
		$this->model('project')->update_project($_POST['project_id'], $_POST['title'], $_POST['category_id'],  $_POST['country'], $_POST['province'], $_POST['city'], $_POST['summary'], $_POST['description'], $_POST['amount'], $_POST['attach_access_key'], $_POST['topics'], $_POST['video_link'], strtotime($_POST['start_time']), strtotime($_POST['end_time']));
