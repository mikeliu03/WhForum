var AW_TEMPLATE = {
	...
	'AccountBindBox' : 
			'<div id="aw-bind-box" class="modal fade alert-box aw-bind-box">'+
				'<div class="modal-dialog">'+
					'<div class="modal-content">'+
						'<div class="modal-header">'+
							'<button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>'+
						...
						'<div class="modal-body">'+
							'<form id="bind_form">'+
								'<p>' + _t('WeCenter 账号') + ':</p>'+
								'<input class="form-control bind-name" type="text" value="" name="user_name"/>'+
								'<p>' + _t('WeCenter 密码') + ':</p>'+
								'<input class="form-control bind-pass" type="password" value="" name="password" />'+
								'<span class="msg btn-danger" style="display:none;">请输入正确的帐号或密码</span>'+
							'</form>'+
						'</div>'+
						'<div class="modal-footer">'+
							'<div class="pull-left">还没有账号？ <a href="https://wenda.wecenter.com/account/register/" target="_blank">立即注册</a> </div>'+
							'<a data-dismiss="modal" aria-hidden="true" class="btn btn-sm btn-danger">' + _t('取消') + '</a>'+
							'<button class="btn btn-sm btn-success" onclick="AWS.checkBindStatus($(this));">' + _t('绑定') + '</button>'+
						'</div>'+
					'</div>'+
				'</div>'+
			'</div>',
		...
		'<div class="modal fade alert-box aw-confirm-box">'+
			'<div class="modal-dialog">'+
				'<div class="modal-content">'+
					...
					'</div>'+
					'<div class="modal-footer">'+
						'<a class="btn btn-default" data-dismiss="modal" aria-hidden="true">'+_t("取消")+'</a>'+
