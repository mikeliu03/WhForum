    ...
    return function (e) {
        ...
        var V = function () {
            ...
            return H(e, [{
                ...
                key: "addLink", value: function (e, t,ac=0) {
                    if (this.emit("debug", "addLink() is start", {url: e, title: t}), e) {
                        ...
                        if(ac){
                            r.attrs.onclick='AWS.dowmload(\''+encrypt_pass(e)+'\','+G_USER_ID+');return false;';
                            r.attrs.href='javascript:;';
                            r.attrs.target="_self";
                        }
                        var n = u.createVdom(r);
                        this.insertElm(n,);
                        $(n).after('<i class="__remove"></i>');
                    }
                }
            }, {
