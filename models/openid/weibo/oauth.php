...
class openid_weibo_oauth_class extends AWS_MODEL
{
    ...
    public function get_access_token()
    {
        ...
        $result = curl_request(self::OAUTH2_TOKEN_URL, http_build_query($args));
    ...
    public function validate_access_token()
    {
        ...
        $result = curl_request(self::OAUTH2_TOKEN_INFO_URL,  http_build_query($args));
    ...
    public function create_comment($access_token, $id, $comment)
    {
        ...
        $result = curl_request(self::COMMENTS_CREATE_URL, http_build_query($args));
