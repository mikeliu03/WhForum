...
class weixin extends AWS_MOBILE_CONTROLLER
{
		...
		else if ($_GET['code'] OR $_GET['state'] == 'OAUTH')
		{
			...
			if ($access_token)
			{
				...
				if (!$access_user['nickname'])
				{
					...
					{
						H::redirect_msg(AWS_APP::lang()->_t('您当前没有关注本公众号主账号, 无法使用身份认证功能,长按识别二维码：<br><img src="/static/css/default/img/wc_code.jpg" width="258px"></img>'));
					}
