...
class article extends AWS_MOBILE_CONTROLLER
{
    ...
    public function index_action()
    {
        ...
        $article_info['message'] = htmlspecialchars_decode(FORMAT::parse_bbcode($article_info['message']));
