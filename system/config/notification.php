...
$config['action_details'][notify_class::TYPE_SYSTEM] = array(
	'user_setting' => 0,
	'combine' => 0,
	'desc' => AWS_APP::lang()->_t('系统消息')
);

$config['action_details'][notify_class::TYPE_TICKET_SUB] = array(
	'user_setting' => 0,
	'combine' => 0,
	'desc' => AWS_APP::lang()->_t('提交工单')
);